                    ...
                    <fieldset class="form-horizontal col-sm-12" style="padding:0 0px 0 0;">                                                    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 addcategory" style="display:none;">
                                    <div class="col-sm-12 input-group" style="background:#fff; padding:5px 0;">
                                            ...
                                            <span class="input-group-btn"> <button type="button" id="save_category" class="btn btn-default"><i class="fa fa-save"></i>
                                                </button> </span>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="description" style="width:100%; height:105px; border:1px solid #eee;" rows="3" required></textarea>
                                </div>
                            </div>
